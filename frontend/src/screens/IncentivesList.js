      ...
      <Background>
        {/* <SafeAreaView style={styles.incentivesList.safeArea}> */}
          <View style={styles.incentivesList.headerContainer} >
            <BackButton style={styles.incentivesList.backButton} goBack={navigation.goBack} />
            <Header style={styles.incentivesList.headerTitle}>All incentives</Header>
          </View>
          <ScrollView style={styles.incentivesList.listFrame}>
        {incentives.map((incentive, index) => (
          <TouchableOpacity key={index} style={styles.incentivesList.card} onPress={() => goToDetail(incentive.id)}>
            <View style={styles.incentivesList.imageContainer}>
              <Image style={styles.incentivesList.image} source={getImagePath(incentive.image)} />
            </View>
            <View style={styles.incentivesList.textContainer}>
              <Text style={styles.incentivesList.title}>{incentive.heading}</Text>
              <Text style={styles.incentivesList.subtitle}>{incentive.title}</Text>
            </View>
          </TouchableOpacity>
        ))}
      </ScrollView>
