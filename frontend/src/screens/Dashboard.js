          ...
          <View style={styles.dashboard.availableIncentives}>
            ...
            >
              <TouchableOpacity style={styles.dashboard.incentiveCard}>
                <Image
                  source={require('../assets/incentive1.png')}
                  style={styles.dashboard.incentiveImage}
                />
              </TouchableOpacity>
              <TouchableOpacity style={styles.dashboard.incentiveCard}>
                <Image
                  source={require('../assets/incentive2.png')}
                  style={styles.dashboard.incentiveImage}
                />
              </TouchableOpacity>
              <TouchableOpacity style={styles.dashboard.incentiveCard}>
                <Image
                  source={require('../assets/incentive3.png')}
                  style={styles.dashboard.incentiveImage}
                />
              </TouchableOpacity>
              <TouchableOpacity style={styles.dashboard.incentiveCard}>
                <Image
                  source={require('../assets/incentive4.png')}
                  style={styles.dashboard.incentiveImage}
                />
              </TouchableOpacity>
              <TouchableOpacity style={styles.dashboard.incentiveCard}>
                <Image
                  source={require('../assets/incentive5.png')}
                  style={styles.dashboard.incentiveImage}
                />
              </TouchableOpacity>
              <TouchableOpacity style={styles.dashboard.incentiveCard}>
                <Image
                  source={require('../assets/incentive6.png')}
                  style={styles.dashboard.incentiveImage}
                />
              </TouchableOpacity>
            </ScrollView>
